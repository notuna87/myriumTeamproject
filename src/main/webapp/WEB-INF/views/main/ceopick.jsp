		...
		<div class="ceopick">
			...
			<div class="ceopickProductwrap">
				...
				<div class="ceopickProduct">
					...
					<p class="ceopickContent">${item.product.product_content}</p>
					...
					<p class="ceosalePrice">
						<span style="color: #e32e15; margin-right: 5px;">${item.product.total_discountrate}%</span><fmt:formatNumber value="${item.product.discount_price}" type="number" groupingUsed="true" />원
					</p>
					<c:if test="${item.product.is_timesales == 1}"><p class="timesaleOntext">🕙타임세일중인 상품입니다 지금 쟁여두세요!</p></c:if>
				</div>
				</c:forEach>
			</div>
