...
<body>
	...
	<div class="categorywrap">
		...
		<div class="categoryButtonWrap">
			<div class="categoryButton select">전체</div>
			<div class="categoryButton">원예용품</div>
			<div class="categoryButton">식물키트모음</div>
			<div class="categoryButton">허브키우기</div>
			<div class="categoryButton">채소키우기</div>
			<div class="categoryButton">꽃씨키우기</div>
			<div class="categoryButton">기타키우기</div>
		</div>
		<!-- 카테고리 버튼 끝 -->
		<!-- 상단 카테고리 선택 끝 -->
		<!-- 하단 상품 카운트 및 정렬 시작 -->
