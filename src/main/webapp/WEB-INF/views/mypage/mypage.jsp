...
<body>
	...
	<div class="mypage-container">
		...
		<main class="content">
			<div class="top-info">
				<div class="info-box">
					<img src="${pageContext.request.contextPath}/resources/img/mypage/person.png" alt="회원등급 아이콘" class="info-icon" /> 씨앗친구<br> <span>회원등급</span>
				</div>
				<div class="info-box">
					<img src="${pageContext.request.contextPath}/resources/img/mypage/won.png" alt="적립금 아이콘" class="info-icon" /> 2,000원<br> <span>총적립금</span>
				</div>
				<div class="info-box">
					<img src="${pageContext.request.contextPath}/resources/img/mypage/coupon.png" alt="쿠폰 아이콘" class="info-icon" /> 4개<br> <span>쿠폰</span>
				</div>
				<div class="info-box">
					<img src="${pageContext.request.contextPath}/resources/img/mypage/check.png" alt="총주문 아이콘" class="info-icon" />
					<fmt:formatNumber value="${totalPaidAmount}" type="number" />
					원<span>총주문</span>
				</div>
			</div>
							...
							<div class="order-box">
								...
								<div class="order-header">
									<div class="order-date">
										<strong>${firstOrder.orderDate}</strong> <span>(${firstOrder.ordersIdfull})</span>
									</div>
